...
/**
 * System Storage Management (SSM) Page Component.
 * Provides full management of Virtual Drives, monitoring, and File Systems management.
 */
@Component({
    selector: 'app-ssm-page',
    templateUrl: './ssm-page.component.html',
    styleUrls: ['./ssm-page.component.scss']
})
export class SsmPageComponent implements OnInit {
