...
/**
 * Entity Storage Management (ESM) Page Component.
 * Provides full management of Virtual Drives owned by the Entity, File Systems,
 * Synchronization, Entity Storage Settings, and Access Rights.
 */
@Component({
    selector: 'app-esm-page',
    templateUrl: './esm-page.component.html',
    styleUrls: ['./esm-page.component.scss']
})
export class EsmPageComponent implements OnInit {
