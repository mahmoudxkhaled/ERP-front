...
const FILE_SYSTEM_ERROR_KEYS: Record<string, string> = {
  ...
  ERP12223: 'fileSystem.admin.errorInvalidFileSize',
  ERP12224: 'fileSystem.admin.errorInvalidNChunks',
  ...
  ERP12233: 'fileSystem.admin.errorNoChunksReceived',
  ERP12234: 'fileSystem.admin.errorChunkEmpty',
